    ...
    <section className="py-20">
      <div className="container relative overflow-x-hidden">
        <div className="">
          ...
          {/* lists  */}
          <div className="grid grid-cols-1 gap-4 mt-10 md:gap-y-4 md:grid-cols-2 xl:grid-cols-3">
            {latestJobLists.map((joblist) => (
              <div
                className="flex flex-col px-6 py-6 transition duration-300 bg-white border rounded-lg shadow-2xl shadow-gray-500/10 hover:-translate-y-2 lg:px-6"
                key={joblist.id}
              >
                <div className="flex items-center mb-4">
                  ...
                  <div>
                    ...
                    <p className="mb-0 text-base font-normal text-textGrayColor">
                ...
                <div className="flex items-center mt-2">
                  <label
                    htmlFor=""
                    className="px-[10px] text-xs py-[4px] lg:text-sm border border-[#56cdad29] select-none text-[#56CDAD] rounded-full bg-[#56CDAD1A] max-w-max whitespace-nowrap"
                  >
                    {joblist.JobType}
                  </label>
